...
#     "dataset_generation/mug_clean/mug.urdf")
urdf_path = "/Users/maggiewang/Workspace/RobotLocomotion/robust_perception/dataset_generation/mug_clean/mug.urdf"
tree = RigidBodyTree()
AddModelInstanceFromUrdfFile(
...
label_index = camera.label_image_output_port().get_index()
label_image = output.get_data(label_index).get_value()
label_array = label_image.data
# print('label_array', label_array.tolist())
...
plt.imshow(np.squeeze(label_array))
plt.show()
