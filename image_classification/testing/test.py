...
# Define transformations for the training set, flip the images randomly,
# crop out and apply mean and std normalization
train_transformations = transforms.Compose([
    transforms.RandomHorizontalFlip(),
    transforms.RandomCrop(32, padding=4),

    # These must be last, in this exact order
    transforms.ToTensor(),        # converts images into format usable by PyTorch
    transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))   # make all pixels range from -1 to +1
])
...
print('created a loader for the training set')
...
model = SimpleNet(num_classes=10)        # will be 5 for me
...
def test():
    ...
    test_acc = test_acc / 10000         # TODO: put this into a var
...
def train(num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        for i, (images, labels) in enumerate(train_loader):
            ...
            # Move images and labels to GPU if avaliable (it's not)
        ...
        train_acc = train_acc / 50000    # TODO put this into a var
