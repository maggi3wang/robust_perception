...
class Optimizer():
    ...
    def __init__(self, num_mugs, mug_lower_bound, mug_upper_bound, max_added_to_training,
        ...
        self.max_added_to_training = max_added_to_training
        self.max_time = 10**8
